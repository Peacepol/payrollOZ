                                ...
                                @foreach($positions as $item)
                                    <tr>
                                        ...
                                        <td>
                                              ...
                                              <form method="POST" action="{{ route( 'empposition.destroy',[session('tenantcode'), $item->id]) }}" style="display:inline">
											 	  {{ method_field('DELETE') }}  	
												  {{ csrf_field() }}
...
@include('references.position_modal')
@push('scripts')
@include('scripts.position')
@endpush
@endsection
