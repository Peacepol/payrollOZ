...
@section('content')
		  ...
		  <div class="modal-dialog" role="document">
			<div class="modal-content">
			  <div class="modal-header">
				<h5 class="modal-title" id="exampleModalLabel">Add New Custom Reference 3</h5>
				...
				<form action = "" method = "POST"> 
					...
					<div class="modal-body">
					  <div class="form-group">
						...
						<input type="input" class="form-control" name= "ref3_code" placeholder="Enter Custom Reference 3 Code">
					  </div>
					  <div class="form-group">
						<label for="costcentrename">Custom Reference Name</label>
						<input type="input" class="form-control" name= "ref3_name" placeholder="Enter Custom Reference 3 Name">
					  </div>				  
					</div>
    ...
    <div class="container">
        <div class="card">
            <div class="card-header">Custom Reference 3</div>
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table id= "customref_table" class="table table-striped">
                            <thead>
                                <tr>
                                        <th>#</th>
                                        <th>Custom Reference 3 Centre Code</th>
                                        <th>Custom Reference 3 Name</th>
                                        <th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($ref3 as $item)
                                    <tr>
                                        <td>{{ $item->id }}</td>
                                        <td>{{ $item->ref3_code }}</td>
                                        <td>{{ $item->ref3_name }}</td>
                                        <td>
