                                ...
                                @foreach($status as $item)
                                    <tr>
                                        ...
                                        <td>
                                              ...
                                              <form method="POST" action="{{ route( 'empstatus.destroy',[session('tenantcode'), $item->id]) }}" style="display:inline">
											 	  {{ method_field('DELETE') }}  	
												  {{ csrf_field() }}
...
@include('references.status_modal')
@push('scripts')
